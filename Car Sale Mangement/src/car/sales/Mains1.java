...
public class Mains1 extends javax.swing.JFrame {
    ...
    private void okbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okbtnActionPerformed
        ...
        SQLConnectionss MyCon = new SQLConnectionss(m1,m2,m3,m4);
        MyCon.CreateDB("carsales");
        //SQLCreateTableTime t3 = new SQLCreateTableTime("time", m1, m2, m3, m4);
        SQLCreateTable11 t = new SQLCreateTable11("add",m1,m2,m3,m4);
        SQLCreateTable22 t2 = new SQLCreateTable22("login",m1,m2,m3,m4);
        String check = null;
        if(found){
            try {
                MyCon = new SQLConnectionss(m1,m2,m3,m4);
                theConn = MyCon.getConnection("carsales");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mains1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
